...
contract  Liquidity_Wallet is Ownable{
    ...
    IERC20 public POT = IERC20(0xa7e5F7471D673fCcd38606FCd6c3dCbdE807D95c);
    
    address public gov;

    event RedeemedAmount(address indexed _address, uint indexed _amount);
    ...
    function Claim(
        ...
        POT.transferFrom(msg.sender, address(this), _amount);

        uint returnAmount = Convert(_amount);
        require(returnAmount > 0, "Invalid Conversion");
        emit RedeemedAmount(msg.sender, returnAmount);
